        ...
        public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
            ...
            if (pageIndex == 0) {
                ...
                try {
                    ...
                    g2d.drawString("---------------------------------------------", 10, y);
                    y += yShift;
                    g2d.drawString(" Total amount  :            " + formatCurrency(totalAmount) + "   ", 10, y);
                    y += yShift;
                    g2d.drawString("---------------------------------------------", 10, y);
                    y += yShift;
                    g2d.drawString(" Discount      :            " + formatCurrency(discount) + "   ", 10, y);
                    y += yShift;
                    g2d.drawString("---------------------------------------------", 10, y);
                    y += yShift;
                    g2d.drawString(" Total Discount:            " + formatCurrency(totalAmountDiscount) + "   ", 10, y);
                    y += yShift;
                    g2d.drawString("---------------------------------------------", 10, y);
                    y += yShift;
