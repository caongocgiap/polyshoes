...
public class MenuJPanel extends javax.swing.JPanel {
        ...
        public void initMenuItem() {
                addMenu(new com.polyshoes.model.trangchu.Menu(new ImageIcon(getClass().getResource("/com/polyshoes/icon/3.png")), "Sản phẩm", Menu.menuType.MENU));
                addMenu(new com.polyshoes.model.trangchu.Menu(new ImageIcon(getClass().getResource("/com/polyshoes/icon/4.png")), "Khuyến mại", Menu.menuType.MENU));
                addMenu(new com.polyshoes.model.trangchu.Menu(new ImageIcon(getClass().getResource("/com/polyshoes/icon/1.png")), "Bán hàng", Menu.menuType.MENU, "Bán tại quầy", "Gửi ship"));
                addMenu(new com.polyshoes.model.trangchu.Menu(new ImageIcon(getClass().getResource("/com/polyshoes/icon/3.png")), "Hóa đơn", Menu.menuType.MENU, "Tạo hóa đơn", "Lịch sử hóa đơn"));
