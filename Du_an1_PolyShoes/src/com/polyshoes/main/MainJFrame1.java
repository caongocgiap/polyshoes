        ...
        private void init() {
                ...
                menu.addEventShowPopup(new EventShowPopupMenu() {
                        ...
                        public void showPopup(Component com) {
                                ...
                                PopupMenu popup = new PopupMenu(MainJFrame1.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
                                int x = MainJFrame1.this.getX() + 52;
                                int y = MainJFrame1.this.getY() + com.getY() + 86;
