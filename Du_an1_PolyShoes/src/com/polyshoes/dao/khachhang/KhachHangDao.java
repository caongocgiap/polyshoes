...
public class KhachHangDao {
        ...
        public void insert(KhachHang model) {
                String sql = "INSERT INTO Khach_hang( MaKH,HoTen,SDT,GioiTinh) VALUES( ?, ?,?,?)"
                        + "INSERT INTO DiaChi( Tinh,Quan,Xa) VALUES(?,?,?)";
...
//    }
        ...
        public List<KhachHang> selectHoaDon1(String MaKH) {
                String sql = "SELECT Khach_Hang.MaKH,Hoa_Don.MaHD,Khach_Hang.HoTen,Khach_Hang.SDT,Khach_Hang.GioiTinh,CONCAT(DiaChi.Xa ,',' ,DiaChi.Quan,',' ,DiaChi.Tinh) AS DiaChiChiTiet,  Hoa_Don.NgayNhan,Hoa_Don.TongTien, Hoa_Don.TrangThai\n"
                        + "FROM Khach_Hang join DiaChi on DiaChi.ID = Khach_Hang.ID \n"
                        + "INNER JOIN  Hoa_Don ON Khach_Hang.ID = Hoa_Don.IDKhachHang where MaKH like ?";
